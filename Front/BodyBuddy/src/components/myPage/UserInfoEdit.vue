<template>
  <div class="container">
    <h4>회원 정보 수정</h4>
      ...
      <div class="item">  
        <div class="form-floating mb-3">
          <input type="text" id="userId" class="form-control" :value="user.userId" disabled>
    ...
    <div class="item">
      <div class="form-floating mb-3">
        <input type="text" id="nickname" class="form-control" v-model="store.joinInfo.nickname" disabled>
    ...
    <div class="item">
      <div class="form-floating mb-3">
        <input type="password" id="password" class="form-control" @input="passwordValid(user.password, user.passwordCheck)" v-model="user.password">
    ...
    <div class="item">
      <div class="form-floating mb-3">
        <input type="password" id="passwordCheck" class="form-control" @input="passwordValid(user.password, user.passwordCheck)" v-model="user.passwordCheck">
    ...
    <div class="item">
      <div class="form-floating mb-3">
        <input type="text" id="email" class="form-control" @input="emailValid(user.email)" v-model="user.email">
      ...
      <div>
          <button @click="store.edit(user)" :disabled="nameFlag !== 1 || !store.joinInfo.nickname || passwordFlag !== 1 || passwordCheckFlag !== 1 || emailFlag !== 1">수정하기</button>
      </div>          
  </div>  
</template>
