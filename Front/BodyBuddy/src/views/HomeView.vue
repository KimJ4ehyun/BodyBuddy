                    ...
                    <div class="carousel-item active">
                        <div class="mainRecBox">
                            ...
                            <div class="info">
                                <p class="rTitle">
                                    <RouterLink
                                        :to="`/board/${boardStore.boardList[0].routineId}`"
                                        >{{
                        ...
                        <div class="mainRecBox">
                            ...
                            <div class="info">
                                <p class="rTitle">
                                    <RouterLink
                                        :to="`/board/${boardStore.boardList[1].routineId}`"
                                        >{{
                        ...
                        <div class="mainRecBox">
                            ...
                            <div class="info">
                                <p class="rTitle">
                                    <RouterLink
                                        :to="`/board/${boardStore.boardList[2].routineId}`"
                                        >{{
                    ...
                    <div class="carousel-item">
                        <div class="mainRecBox">
                            ...
                            <div class="info">
                                <p class="rTitle">
                                    <RouterLink
                                        :to="`/board/${boardStore.boardList[3].routineId}`"
                                        >{{
                        ...
                        <div class="mainRecBox">
                            ...
                            <div class="info">
                                <p class="rTitle">
                                    <RouterLink
                                        :to="`/board/${boardStore.boardList[4].routineId}`"
                                        >{{
                        ...
                        <div class="mainRecBox">
                            ...
                            <div class="info">
                                <p class="rTitle">
                                    <RouterLink
                                        :to="`/board/${boardStore.boardList[5].routineId}`"
                                        >{{
