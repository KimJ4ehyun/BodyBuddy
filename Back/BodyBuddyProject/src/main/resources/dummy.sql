...
values ('yelim123', '헬스 초보 루틴', date_format(now(), '%Y%m%d'), '뉴비에용');
...
values ('1', 'jaehyun12', 'Spiral', '너무 좋아요', date_format(now(), '%Y%m%d'));

insert into reviews (routine_id, user_id, nickname, content, date)
values ('1', 'wngud1225', '레전드홍쪽이', '운동 그렇게 하는 거 아닌데...', date_format(now(), '%Y%m%d'));

# 루틴 2
        
insert into routines (user_id, routine_title, date, description)
values ('jaehyun12', '3분할', date_format(now(), '%Y%m%d'), '하체는 안 한다는 마인드~');
...
insert into reviews (routine_id, user_id, nickname, content, date)
values ('2', 'yelim123', 'yelim', '하체도 해야겠지?', date_format(now(), '%Y%m%d'));

insert into reviews (routine_id, user_id, nickname, content, date)
values ('2', 'wngud1225', '레전드홍쪽이', '밸런스도 신경 쓰셔야합니다.', date_format(now(), '%Y%m%d'));

# 루틴 3

insert into routines (user_id, routine_title, date, description)
values ('yelim123', '강력한 예림이 만들기', date_format(now(), '%Y%m%d'), '강력한 예림이 프로젝트');
...
insert into reviews (routine_id, user_id, nickname, content, date)
values ('3', 'wngud1225', '레전드홍쪽이', '강력한 예일리', date_format(now(), '%Y%m%d'));

insert into reviews (routine_id, user_id, nickname, content, date)
values ('3', 'jaehyun12', 'Spiral', '가보자~ 가보자~', date_format(now(), '%Y%m%d'));


# 루틴 4

insert into routines (user_id, routine_title, date, description)
values ('jaehyun12', '맨몸 조지기', date_format(now(), '%Y%m%d'), '맨몸운동만 해요');
...
insert into reviews (routine_id, user_id, nickname, content, date)
values ('4', 'wngud1225', '레전드홍쪽이', '너무 좋은데?', date_format(now(), '%Y%m%d'));

insert into reviews (routine_id, user_id, nickname, content, date)
values ('4', 'yelim123', 'yelim', '초보자도 따라할 만 해요', date_format(now(), '%Y%m%d'));
        
# 루틴 5

insert into routines (user_id, routine_title, date, description)
values ('yelim123', '무분할', date_format(now(), '%Y%m%d'), '한 주에 2번 무분할 운동 ㄱㄱ');
...
insert into reviews (routine_id, user_id, nickname, content, date)
values ('5', 'jaehyun12', 'Spiral', '잘 보고 갑니다~', date_format(now(), '%Y%m%d'));

insert into reviews (routine_id, user_id, nickname, content, date)
values ('5', 'wngud1225', '레전드홍쪽이', '루틴 그대로 따라했더니 몸짱됐어요~', date_format(now(), '%Y%m%d'));

# 루틴 6

insert into routines (user_id, routine_title, date, description)
values ('jaehyun12', '다이어트용', date_format(now(), '%Y%m%d'), '유산소만 한가득');
...
insert into reviews (routine_id, user_id, nickname, content, date)
values ('6', 'wngud1225', '레전드홍쪽이', '살 한 번 빼보자!', date_format(now(), '%Y%m%d'));
